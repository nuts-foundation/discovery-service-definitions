...
curl -s -S -f -o $BASEDIR/dev_homemonitoring_ura2024.json https://raw.githubusercontent.com/nuts-foundation/discovery-service-definitions/main/definitions/dev_homemonitoring_ura2024.json
